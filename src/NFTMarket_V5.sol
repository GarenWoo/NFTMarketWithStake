...
contract NFTMarket_V5 is INFTMarket_V5, IERC721Receiver {
    ...
    address public immutable KKToken_CompoundStake;     // the ERC-20 token used to represent the shares of WETH staking(compound interest).
    ...
    constructor(address _tokenAddr, address _wrappedETHAddr, address _routerAddr, address _KKToken_CompoundStake) {
        ...
        KKToken_CompoundStake = _KKToken_CompoundStake;
    }
     ...
     * Using the algorithm of ERC4626(a financial model of compound interest and re-invest) to calculate the amount of minted shares(i.e. KKToken_CompoundStake).
     * 
